...
<body>
    <div class="head">
            ...
            <h3 class="head_text fr">回收咖后台管理系统</h3>
    </div>
    <div class="operation_user clearfix">
        <div class="link fr">
            ...
            </b>&nbsp;&nbsp;&nbsp;&nbsp;<a href="index.php" class="icon icon_i">首页</a><span></span><a onclick="op('go');" class="icon icon_j">前进</a><span></span><a onclick="op('back');" class="icon icon_t">后退</a><span></span><a href="javascript:location.reload();" class="icon icon_n">刷新</a><span></span><a href="doAdminAction.php?act=logout" class="icon icon_e">退出</a>
        </div>
    </div>
